# pip install yt_dlp requests requests
...
class App(ttk.Frame):
    ...
    def setup_widgets(self):
        ...
        self.label = ttk.Label(
            self.widgets_frame,
            text="Insert the link(s) to the video separated by commas (No Threads)",
            justify="center",
    ...
    def download_video(self, video_url):
        try:
            ...
            # Current date and time, conversion to string
...
if __name__ == "__main__":
    ...
    root.title("Download video from YouTube or VK (no Threads => no Bans)")
